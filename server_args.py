...
class ServerArgs:
    ...
    enable_online_ttt: bool = False
    online_ttt_interval: int = 10
    online_ttt_lr: float = 1e-5
    online_ttt_device: str = "cuda:1"
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            "--enable-online-ttt",
            action="store_true",
            help="Enable Online Training-Time Test (TTT) for speculative decoding.",
        )
        parser.add_argument(
            "--online-ttt-interval",
            type=int,
            default=10,
            help="Number of requests between online TTT updates.",
        )
        parser.add_argument(
            "--online-ttt-lr",
            type=float,
            default=1e-5,
            help="Learning rate for the shadow trainer in Online TTT.",
        )
